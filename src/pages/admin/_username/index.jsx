...
class AdminUsername extends Component {
  ...
  navigateToCreatePost = () => {
    ...
    history.push(`/admin/${username}/users/create`);
  };
  navigateToAddQuestions = () => {
    const { history, username } = this.props;
    history.push(`/admin/${username}/questions/create`);
  };
  onChange = (event) => {
      ...
      <div className="admin-username">
        <Card>
          <Card.Content>
            ...
            <Button className="mr-one" color="primary" onClick={this.navigateToCreatePost}>
              Add User
            </Button>
            <Button className="mr-one" color="primary" onClick={this.navigateToAddQuestions}>
              Add Questions
            </Button>
